...
public class State {
    ...
    public State push() {
        ...
        glGetIntegerv(GL_SCISSOR_BOX, props.lastScissorAABB);
    ...
    public State pop() {
        ...
        glScissor(props.lastScissorAABB[0], props.lastScissorAABB[1], props.lastScissorAABB[2], props.lastScissorAABB[3]);
