...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public MsdfFont.Builder data(String dataFileName) {
			this.dataIdentifer = ResourceLocation.fromNamespaceAndPath("mre", "fonts/" + dataFileName + ".json");
			return this;
		}
		
		public MsdfFont.Builder atlas(String atlasFileName) {
			this.atlasIdentifier = ResourceLocation.fromNamespaceAndPath("mre", "fonts/" + atlasFileName + ".png");
			return this;
		}
