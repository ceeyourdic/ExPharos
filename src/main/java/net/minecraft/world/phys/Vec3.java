...
public class Vec3 implements Position {
    ...
    // Arcane mixin port: Yarn helper name for official atLowerCornerOf(Vec3i).
    public static Vec3 of(Vec3i pToCopy) {
        return atLowerCornerOf(pToCopy);
    }

    // Arcane mixin port: Yarn rotation-vector helper.
    public static Vec3 fromPolar(float pPitch, float pYaw) {
    ...
    // Arcane mixin port: Yarn helper name for official atCenterOf(Vec3i).
    public static Vec3 ofCenter(Vec3i pToCopy) {
        return atCenterOf(pToCopy);
    }
    ...
    // Arcane mixin port: compatibility aliases for Yarn-style Vec3 accessors.
    public double getX() {
        return this.x;
    }
    ...
    // Arcane mixin port: Yarn name for official lengthSqr().
    ...
    // Arcane mixin port: Yarn name for official with(axis, value).
    public Vec3 withAxis(Direction.Axis pAxis, double pLength) {
        return this.with(pAxis, pLength);
    }
