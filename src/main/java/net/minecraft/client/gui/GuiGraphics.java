...
public class GuiGraphics implements IForgeGuiGraphics {
    ...
    // Arcane mixin port: compatibility alias for Yarn-style DrawContext matrix access.
    ...
    // Arcane mixin port: Yarn name for centered text with shadow.
    public void drawCenteredTextWithShadow(Font pFont, String pText, int pX, int pY, int pColor) {
        this.drawCenteredString(pFont, pText, pX, pY, pColor);
    }
    ...
    // Arcane mixin port: Yarn names this drawItem(); official uses renderItem().
    public void drawItem(ItemStack pStack, int pX, int pY) {
        this.renderItem(pStack, pX, pY);
    }
