...
public class PoseStack implements IForgePoseStack {
    ...
    // Arcane mixin port: compatibility alias for old matrix helpers that called scale with a quaternion.
    public void scale(Quaternionf quaternion) {
    ...
    // Arcane mixin port: compatibility alias for Yarn-style PoseStack calls used by the ported client UI.
    public void push() {
        this.pushPose();
    }
    ...
    public static final class Pose {
        ...
        // Arcane mixin port: compatibility alias for Yarn-style MatrixStack.Entry access.
