...
public class BufferBuilder implements VertexConsumer {
    ...
    public BufferBuilder(ByteBufferBuilder pBuffer, VertexFormat.Mode pMode, VertexFormat pFormat) {
        this(pBuffer, pMode, pFormat, null);
    }
    ...
    // Arcane mixin port: compatibility aliases for Yarn-style BufferBuilder calls used by old render helpers.
    public MeshData end() {
    ...
    // Arcane mixin port: compatibility aliases for Yarn-style chained vertex calls.
